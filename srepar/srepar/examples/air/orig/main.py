"""
Source: `pyro/examples/air/main.py` from Pyro 1.3.0.
...
def main(**kwargs):
    ...
    # WL: added for test. =====
    # i = 0
    # loss = svi.evaluate_loss(X, batch_size=None, z_pres_prior_p=partial(z_pres_prior_p, i))
